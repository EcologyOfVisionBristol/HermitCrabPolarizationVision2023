...
%datadir = 'C:\Users\mh13223\OneDrive - University of Bristol\marvefiles5\projects\CrabPolVision\20200212_MaheCrabs\20200216_PaleHermit4_i';
%datadir = 'C:\Users\mh13223\OneDrive - University of Bristol\marvefiles5\projects\CrabPolVision\20200212_MaheCrabs\20200218_PurpleHermit_P';
...
for pp=[1 2 4 5]
    ...
    for ff=1:size(flist,1)
        ...
        if size(flist(ff).name,2)>5 && strcmp(fext,'.mat')
            ...
            load(fullfile(datadir,flist(ff).name));
